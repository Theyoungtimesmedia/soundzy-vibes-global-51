    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        ...
        <div className="relative">
          ...
          >
            <a
              href="https://wa.me/2348166687167?text=Hi,%20I'm%20interested%20in%20Soundzy%20World%20Global%20services.%20Can%20you%20help%20me?"
              target="_blank"
          ...
          <div className="grid md:grid-cols-4 gap-12">
            ...
            <div className="md:col-span-1">
              <div className="flex items-center gap-3 mb-6">
                <img 
                  src="/lovable-uploads/522535fe-b8e2-4598-aaa4-fe680d012385.png" 
                  alt="Soundzy World Global Logo" 
            ...
            <div>
              ...
              <div>
                ...
                <div className="flex items-center gap-4">
                  <a 
                    href="https://www.youtube.com/@soundzyofficial6917?si=pYlzXM16pSDNONWZ"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-8 h-8 hover:scale-110 transition-transform"
                  >
                    <img 
                      src="/lovable-uploads/d473772a-e449-48b9-8ee9-d9eb33f959a6.png" 
                      alt="YouTube" 
                      className="w-full h-full object-contain"
                    />
                  </a>
                  <a 
                    href="https://www.tiktok.com/@soundzyofficial?_t=ZS-8zOWgJ6vZS4&_r=1"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-8 h-8 hover:scale-110 transition-transform"
                  >
                    <img 
                      src="/lovable-uploads/a8477a7f-9c2f-4a55-99af-84fd482a5076.png" 
                      alt="TikTok" 
                      className="w-full h-full object-contain"
                    />
                  </a>
                  <a 
                    href="#"
                    className="w-8 h-8 hover:scale-110 transition-transform opacity-50"
                    title="Instagram - Coming Soon"
                  >
                    <img 
                      src="/lovable-uploads/161d31ff-fdd9-4b31-bdb6-503ad5bf8f20.png" 
                      alt="Instagram" 
                      className="w-full h-full object-contain"
                    />
                  </a>
                  ...
                  >
                    <img 
                      src="/lovable-uploads/4343b4e2-4b11-4c0b-9f3d-5b271c7c1e8a.png" 
                      alt="Facebook" 
                      className="w-full h-full object-contain"
                    />
                  </a>
          ...
          <div className="border-t mt-12 pt-12">
            <div className="max-w-md mx-auto text-center">
              ...
              <p className="text-sm text-muted-foreground mb-6">
                Stay updated with our latest events and services.
              </p>
              <div className="flex gap-2">
                <input 
                  type="email" 
                  placeholder="Your email" 
                  className="flex-1 px-4 py-2 border border-input rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-primary"
                />
